...
// settings.resolution says; THIS is just the screencast feed pulled out of
// chromium. Chromium downscales server-side (cheaper than us doing it after),
// the encoder transcodes the smaller frames (cheaper H264), and the client's
// <video> element upscales via CSS object-fit. Mouse coords arrive as
// normalized 0..1 and get rescaled to the real kiosk viewport server-side,
// so the preview resolution is completely independent of the kiosk one.
